...
function activity1() {
    ...
    <div style='margin-top: 2vw;'>
        ...
        <div class="fs-16px">
        <h5>Double Integration Simposon's (1/3rd) Rule</h5>
    ...
    <div class='collapse divide' style='style='margin-top: 2vw; 'width: 80%; margin: auto;' id='tb12-box'>
        ...
        <div style='text-align: center;'>
            ...
            <div style='text-align: center;' class='row'>
                ...
                <div id='bs-inp-div' style='text-align: center;'><span style='font-size: 30px;'>$$ h_x = \\frac{x_2 - x_1}{2n} \\ = \\ $$</span> <input type='number' class='form-control' style='display: inline !important; width: 100px;' id='hx-inp' > <span id='hx-val-sp'></span></div>

                <div id='bs-inp-div' style='text-align: center;'><span style='font-size: 30px;'>$$ h_y = \\frac{y_2 - y_1}{2m} \\ = \\ $$</span><input type='number' class='form-control' style='display: inline !important; width: 100px;' id='hy-inp' > <span id='hy-val-sp'></span></div>
            </div>
